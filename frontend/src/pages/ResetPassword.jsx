    ...
    <div className="flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from blue-200 to-purple-400">
      ...
      {!isEmailSent && 
        ...
        <form onSubmit={onSubmitEmail} className="bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm">
          <div className="relative">
            <img onClick={()=>navigate('/login')} src={assets.left_arrow} className="h-6 w-6 cursor-pointer rounded-full bg-white"/>
          ...
          <div className="mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]">
            ...
            <input type="email" placeholder="Email id" className="bg-transparent outline-none text-white" onChange={(e)=>setEmail(e.target.value)} value={email}/>
          </div>
          <button type="submit" className="cursor-pointer w-full py-2.5 bg-gradient-to-r from-indigo-500 to-indigo-900 text-white rounded-full mt-3">Submit</button>
        </form>
      } 
      ...
      <form onSubmit={onSubmitNewPassword} className="bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm">
        ...
        <div className="mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]">
          ...
          <input type="password" placeholder="Password" className="bg-transparent outline-none text-white" onChange={(e)=>setNewPassword(e.target.value)} value={newPassword}/>
        </div>
