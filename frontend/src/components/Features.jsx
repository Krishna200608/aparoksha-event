      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-14 text-center">
          ...
          <h2 className="text-4xl font-bold text-gray-900 py-5">
            Revolutionary Event Features
          </h2>
          <p className="text-lg font-normal text-black max-w-md md:max-w-2xl mx-auto">
            Discover powerful tools designed for Aparoksha, our premier college
            technical event. Enjoy smart scheduling, seamless integrations, real-time analytics, and automated workflows.
          </p>
        </div>
        <div className="flex justify-center items-center gap-x-5 gap-y-8 flex-wrap md:flex-wrap lg:flex-nowrap lg:justify-between lg:gap-x-8">
          ...
          <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
            ...
            <p className="text-sm font-normal text-gray-500">
              Easily plan sessions, allocate resources, and manage your event timeline.
            </p>
          </div>
          ...
          <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
            ...
            <p className="text-sm font-normal text-gray-500">
              Connect with popular calendars and ticketing platforms to streamline event management.
            </p>
          </div>
          ...
          <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
            ...
            <p className="text-sm font-normal text-gray-500">
              Monitor registrations, session popularity, and audience engagement as they happen.
            </p>
          </div>
          ...
          <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
            ...
            <p className="text-sm font-normal text-gray-500">
              Streamline event operations with automated scheduling, notifications, and task management.
            </p>
          </div>
